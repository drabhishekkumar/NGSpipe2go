...
VariantEval = {
    ...
    transform (".vcf.gz") to (".report") {
        ...
        exec """
            ...
            ${RUN_JAVA} -Djava.io.tmpdir=$TMPDIR -jar ${TOOL_GATK}/GenomeAnalysisTK.jar -T VariantEval -R $GATK_BWA_REF -nt $GATK_THREADS --dbsnp ${GATK_KNOWN_VARIANTS} --eval $input -o $output;
        ""","VariantEval"
    }
